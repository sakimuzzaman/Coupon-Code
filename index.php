...
<head>
    ...
    <title>Promocode apply In PHP </title>
...
<body>
  <div class="container">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-group" id="total_price" name="total_price" value="1000.00">
    </div>
...
<script>
    $("#apply").click(function(){
        if($('#promo_code'.val()!=''){
            ...
            $('#message').html("Promocode can not be blank. Enter a Valid Promode !");
        }
